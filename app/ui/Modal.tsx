...
const Modal = ({ selectedRecipe, ingredients, setModalActive }: ModalProps) => {
  ...
  return (
    <div className=" bg-black/75 w-full h-screen fixed top-0 right-0 z-10">
      <div className="border fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] bg-white rounded-lg px-8 py-4 max-h-[90%] min-w-[90%] lg:min-w-[80%] overflow-scroll md:overflow-hidden">
        <p
        ...
        <div className="flex flex-col md:flex-row mt-6 md:items-center">
          ...
          <div className="lg:w-[65%] md:mx-12">
            ...
            <button className="bg-orange-400 text-white w-full p-2 rounded-md font-bold text-lg hover:bg-orange-700">
              Save Recipe
            </button>
          </div>
        </div>
